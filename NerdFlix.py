...
headersTeste = ['Código', 'Nome', 'Tipo', 'Preço']
    ...
    while True:
        for i in cadastro:
            ...
            if voltar == "s":
                ...
                codigoCliente = int(input("Insira o código do produto: "))

        print(f'\n{tabulate([cadastro[teste]], headers=headers)}')
        print(f'Valor total: {sum(valorTotal)}')
